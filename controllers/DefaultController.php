...
namespace ravesoft\menu\controllers;
...
{
    public $modelClass = 'ravesoft\models\Menu';
    public $modelSearchClass = 'ravesoft\menu\models\search\SearchMenu';
    public $modelLinkSearchClass = 'ravesoft\menu\models\search\SearchMenuLink';
