...
namespace ravesoft\menu\models\search;
...
/**
 * SearchMenuLink represents the model behind the search form about `ravesoft\menu\models\MenuLink`.
 */
class SearchMenuLink extends MenuLink
{
    ...
    public function search($params = [])
    {
        ...
        $restrictLinkAccess = (RaveHelper::isImplemented(MenuLink::className(), OwnerAccess::CLASSNAME)
